...
# RUN_TYPE
#
# Use the outer Unified Catalog object ID,
# not source.columnId.
...
with PurviewClient(
    ...
    print("=" * 80)
    print("Critical Data Element - Add Data Column relationship")
    print("=" * 80)
    ...
    if DATA_COLUMN_ID in existing_column_ids:
        ...
        created_relationship = client.relationships.create(
            ...
            description=(
                "Data Column linked to CDE through "
        ...
        if DATA_COLUMN_ID in after_column_ids:
            ...
            raise RuntimeError(
                ...
                "Data Column was not found when the CDE "
